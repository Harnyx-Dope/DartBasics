...
class RowsWannatry extends StatefulWidget {
  const RowsWannatry({Key? key}) : super(key: key);

  @override
  State<RowsWannatry> createState() => _DumbBellPressWannaTry();
}

class _DumbBellPressWannaTry extends State<RowsWannatry>
                    ...
                    child: Container(
                        ...
                        child: ListView(
                          children: [
                            Column(children: [
                              Text(
                                """Step-1: Load your barbell with an appropriate weight.
